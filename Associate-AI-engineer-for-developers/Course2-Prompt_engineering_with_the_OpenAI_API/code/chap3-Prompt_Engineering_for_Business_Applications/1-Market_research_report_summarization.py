...
prompt = f"""Summarize the text delimited by triple backticks, in at most five sentences, focusing on aspects related to AI and data privacy\
            ```{report}```"""
...
# Summarized report: 
#      The report highlights the transformative role of Artificial Intelligence (AI) in customer service and engagement, particularly through the use of chatbots and predictive analytics to forecast customer behavior. However, it emphasizes the growing concerns surrounding data privacy, driven by regulations like GDPR and CCPA, which affect how companies manage customer data. Strengthening cybersecurity measures is deemed essential to protect against data breaches and cyber threats. Businesses are encouraged to invest in AI and data analytics for personalized customer experiences while ensuring compliance with data privacy regulations. Overall, a focus on data security, alongside innovation and customer-centric strategies, is crucial for companies to remain competitive in the evolving market landscape.
